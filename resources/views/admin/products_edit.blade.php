...
<div class="main-content-inner">
    ...
    <option value="">Choose Category</option> <!-- Placed outside the loop -->
    ...
    <option value="">Choose Brand</option> <!-- Placed outside the loop -->
    @foreach($brands as $brand)
        <option value="{{$brand->id}}" {{ isset($product) && $product->brand_id == $brand->id ? 'selected' : '' }} > {{$brand->name}}
        </option>
    @endforeach
</select>
                                        ...
                                        <fieldset class="shortdescription">
                                            ...
                                            <textarea class="mb-10 ht-150" name="short_description" placeholder="Short Description" tabindex="0" value="{{$product->short_description}}" aria-required="true" required=""></textarea>
                                        ...
                                        <fieldset class="description">
                                            ...
                                            <textarea class="mb-10" name="description" placeholder="Description" tabindex="0" value="{{$product->description}}" aria-required="true" required=""></textarea>
                                            <div class="text-tiny">Do not exceed 100 characters when entering the
                                                product name.</div>
                                        </fieldset>
                                        ...
                                        <div class="cols gap22">
                                            <fieldset class="name">
                                                ...
                                                <input class="mb-10" type="text" placeholder="Enter regular price"
                                                    name="regular_price" tabindex="0" value="" aria-required="true" value="{{$product->regular_price}}"
                                                    required="">
                                            </fieldset>
