                ...
                <div class="wg-box">
                    ...
                    <fieldset class="shortdescription">
                        ...
                        <textarea class="mb-10 ht-150" name="short_description" placeholder="Short Description" tabindex="0"
                            value="{{ old('short_description') }}" aria-required="true" required=""></textarea>
                    ...
                    <fieldset class="description">
                        ...
                        <textarea class="mb-10" name="description" placeholder="Description" tabindex="0"value="{{ old('description') }}"
                ...
                <div class="wg-box">
                    ...
                    <div class="cols gap22">
                        <fieldset class="name">
                            ...
                            <input class="mb-10" type="text" placeholder="Enter regular price" name="regular_price"
                                tabindex="0" value="" aria-required="true" value="{{ old('regular_price') }}"
                                required="">
                        </fieldset>
                        @error('regular_price')
                            <span class="alert alert-danger text-center">{{ $message }}</span>
                    ...
                    <div class="cols gap22">
                        ...
                        @enderror
                                        ...
                                        <fieldset class="shortdescription">
                                            <div class="body-title mb-10">Short Description <span class="tf-color-1">*</span></div>
                                            <textarea class="mb-10 ht-150" name="short_description" placeholder="Short Description" tabindex="0" value="{{old('short_description')}}" aria-required="true" required=""></textarea>
                                            <div class="text-tiny">Do not exceed 100 characters when entering the
                                                product name.</div>
                                        </fieldset>
                                        ...
                                        <fieldset class="description">
                                            ...
                                            <textarea class="mb-10" name="description" placeholder="Description" tabindex="0"value="{{old('description')}}" aria-required="true" required=""></textarea>
                                            <div class="text-tiny">Do not exceed 100 characters when entering the
                                                product name.</div>
                                        </fieldset>
                                        ...
                                        <div class="cols gap22">
                                            <fieldset class="name">
                                                ...
                                                <input class="mb-10" type="text" placeholder="Enter regular price"
                                                    name="regular_price" tabindex="0" value="" aria-required="true" value="{{old('regular_price')}}"
                                                    required="">
                                            </fieldset>
